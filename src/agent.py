...
class AsterRowAgent:
    ...
    ABSTENTION_ANSWER_PATTERNS = [
        ...
        r"do(?:es)?n?'?t (?:have|contain) (enough |sufficient )?information",
        r"do (?:not|n't) (?:have|contain) (enough |sufficient )?information",
        r"does (?:not|n't) (?:have|contain) (enough |sufficient )?information",
        r"cannot confirm",
        r"unable to confirm",
        r"cannot determine",
